...
if MappingNum == 1
    ...
    UNames.CTRL = {'ULAT','ULON','UDIR','CPRPM','LPRPM'};
    
    UTrimVec0 = [ULATGuess,ULONGuess,UDIRGuess,RPMGuess,LPRPMGuess]';
    
    Bounds = [ULATBounds;ULONBounds;UDIRBounds;CPRPMBounds;LPRPMBounds];
    ...
    % minimize cruise prop rpm
    fobj(1) = 0.01*rpm_cp;
    % minimze lift prop rpm
    fobj(2) = 0.01*rpm_lp;
    % minimize longitudinal input
    fobj(3) = 0; %ulon; changed
