function [VertColl,VertColl_FSBLWL]=makeAC3D_rotors(geom, filename, mats,PlotMode,TrackPts)
...
plotObjectGroup(fh,geom.(Objects{n}), 1,ObjectName,PlotMode);
    %VertColl = [VertColl;geom.(Objects{n}).Vertices];
end
fclose(fh);
...
function plotObjectGroup(fh,parameters, mat,ObjectName,PlotMode)
