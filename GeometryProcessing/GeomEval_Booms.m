function [Fus] =  GeomEval_Booms(Fus)
global Settings
...
if Fus.Nose == 0
FUS(:,2) = [1 1 1 1 1 1 1 1]' ;
FUS(:,3) = [-1 -1 -1 -1 -1 -1 -1 -1]' ;
FUS(:,4) = [1 1 1 1 1 1 1 1]' ;
end

if Fus.Direction == -1
   n = length(FUS);
      FUS(1:n,2) = sort(FUS(1:n,2),'descend') ;
      FUS(1:n,3) = sort(FUS(1:n,3)) ; 
      FUS(1:n,4) = sort(FUS(1:n,4),'descend') ;
